...
const BiSearch = dynamic<React.ComponentProps<IconType>>(() => import('react-icons/bi').then(mod => mod.BiSearch ), { ssr: true })
const BiSolidCopy = dynamic<React.ComponentProps<IconType>>(() => import('react-icons/bi').then(mod => mod.BiSolidCopy ), { ssr: true })
const TbCut = dynamic<React.ComponentProps<IconType>>(() => import('react-icons/tb').then(mod => mod.TbCut ), { ssr: true })

const LuClipboardPaste = dynamic<React.ComponentProps<IconType>>(() => import('react-icons/lu').then(mod => mod.LuClipboardPaste ), { ssr: true })

const SiPrettier = dynamic<React.ComponentProps<IconType>>(() => import('react-icons/si').then(mod => mod.SiPrettier ), { ssr: true })
